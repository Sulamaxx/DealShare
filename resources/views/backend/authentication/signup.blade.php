                        ...
                        <div class="flex justify-between gap-2">
                            <div class="form-check style-check flex items-start gap-2">
                                ...
                                <label class="text-sm" for="condition">
                                    ...
                                    <a href="{{ route('pages') }}?tab=term_and_services"
                                        class="text-primary-600 font-semibold">Terms & Conditions</a> and our
                                    <a href="{{ route('pages') }}?tab=privacy"
                                        class="text-primary-600 font-semibold">Privacy
                                        Policy</a>
                                </label>
                            </div>
