                ...
                <div class="col-span-12 lg:col-span-10 xl:col-span-8 2xl:col-span-6 2xl:col-start-4">
                    <div class="card border border-neutral-200 dark:border-neutral-600">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.updateTopBanner') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-6 mt-4">
                                    <div class="avatar-upload" style="max-width:100vw">
                                        ...
                                        <div class="avatar-preview" style="min-height:200px;width:100%;border-radius:0px;">
                                            <div id="imagePreview"
                                                style="background-image: url({{ $banner['top_banner'] === 'images/banner.png' ? asset($banner['top_banner']) : asset('storage/' . $banner['top_banner']) }});border-radius:0px;background-size: contain;">
