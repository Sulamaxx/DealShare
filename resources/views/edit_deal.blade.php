    ...
    <main id="tt-pageContent" class="p-5">
        <div class="container">
            <div class="tt-wrapper-inner mb-5">
                ...
                <form class="form-default form-create-topic" action="{{ route('posts.update') }}" method="PUT"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="inputTopicTitle"
                            placeholder="Subject of your topic" value="{{ $post->title }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="link" class="form-control" id="inputDealLink"
                            placeholder="eg: https://example.com" value="{{ $post->link }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="discount_text" class="form-control" id="inputDiscountText"
                            placeholder="eg: 20% OFF" value="{{ $post->discount_text }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price_saving" class="form-control" id="inputPriceSaving"
                            placeholder="eg: Save 800 LKR" value="{{ $post->price_saving }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" id="inputDescription" rows="5"
                            placeholder="Write details here..." value="{{ $post->description }}" required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" class="form-control" id="inputCategory" required>
                            ...
                            <option value="Shopping Advice" {{ $post->category == 'Shopping Advice' ? 'selected' : '' }}>Shopping Advice</option>
                            <option value="Product Reviews" {{ $post->category == 'Product Reviews' ? 'selected' : '' }}>Product Reviews</option>
                            <option value="Consumer Rights" {{ $post->category == 'Consumer Rights' ? 'selected' : '' }}>Consumer Rights</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" src="{{ asset($post->image) }}" class="form-control-file" id="inputImage" accept="image/*">
                    </div>
